...
const en = {
  ...
  "marker.freehandTool": "Freehand tool",
  "marker.textTool": "Text tool",
  "marker.deleteTool": "Mark deletion tool",
  "marker.freehandProperties": "Freehand properties",
  "marker.textProperties": "Text properties",
  "marker.quickInsertLabel": "Quick insert",
  "marker.quickInsert.rect": "Insert rectangle once",
  "marker.quickInsert.ellipse": "Insert ellipse once",
  "marker.quickInsert.triangle": "Insert triangle once",
  "marker.quickInsert.line": "Insert line once",
  "marker.quickInsert.arrow": "Insert arrow once",
...
const ko: Record<Key, string> = {
  ...
  "settings.fixed": "고정",
  "marker.freehandTool": "자유곡선 도구",
  "marker.textTool": "텍스트 도구",
  "marker.deleteTool": "마크 삭제 도구",
  "marker.freehandProperties": "자유곡선 속성",
  "marker.textProperties": "텍스트 속성",
  "marker.quickInsertLabel": "빠른 추가",
  "marker.quickInsert.rect": "사각형 한 번 추가",
  "marker.quickInsert.ellipse": "타원 한 번 추가",
  "marker.quickInsert.triangle": "삼각형 한 번 추가",
  "marker.quickInsert.line": "직선 한 번 추가",
  "marker.quickInsert.arrow": "화살표 한 번 추가",
  "marker.colorLabel": "색",
